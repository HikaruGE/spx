 ...
 * Lab
 * Md. Adil Akhter <md.adilakhter add gmail.com>
 ******************************************************************************/
...
public class ImagePreviewPane extends Dialog {
	...
	private void createImagePreviewPane() {
		...
		saveItem.setImage(SpoofaxlangDependencyViewImages.get(SpoofaxlangDependencyViewImages.IMG_SAVEEDIT));
	...
	public void open (Image image, Point size) {
 		...
 		shell.setImage(SpoofaxlangDependencyViewImages.get(SpoofaxlangDependencyViewImages.IMG_REQ_PLUGIN_OBJ));
